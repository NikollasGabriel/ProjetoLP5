...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="FrontController?action=GravarViceCoordenador" method="post" name="frmGravarViceCoordenador" onsubmit="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="usr" name="txtSalarioViceCoordenador">
                </div>
